...
${user_name} ALL=(ALL) NOPASSWD: /usr/local/bin/millennium-upgrade-stable, /usr/local/bin/millennium-upgrade-beta, /usr/local/bin/millennium-diag, /usr/local/bin/millennium-purge
EOF
