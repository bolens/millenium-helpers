...
# Automatically generated by Millennium helpers installer. Do not edit manually.
${new_user} ALL=(ALL) NOPASSWD: /usr/local/bin/millennium-upgrade-stable, /usr/local/bin/millennium-upgrade-beta, /usr/local/bin/millennium-diag, /usr/local/bin/millennium-purge, /usr/local/bin/millennium-repair
EOF
