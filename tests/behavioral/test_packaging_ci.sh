...
assert_file_exists "${REPO_ROOT}/scripts/lib/schedule_hooks.sh" "scripts/lib/schedule_hooks.sh exists for release packaging"
assert_file_exists "${REPO_ROOT}/scripts/lib/schedule_wizard.sh" "scripts/lib/schedule_wizard.sh exists for release packaging"
