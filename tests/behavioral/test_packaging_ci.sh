...
assert_file_not_exists "${REPO_ROOT}/scripts/lib/schedule_timer.sh" "schedule_timer.sh peeled (enable/disable thin-wraps to Go)"
assert_file_not_exists "${REPO_ROOT}/scripts/lib/schedule_cron.sh" "schedule_cron.sh peeled (enable/disable thin-wraps to Go)"
assert_file_not_exists "${REPO_ROOT}/scripts/lib/schedule_hooks.sh" "schedule_hooks.sh peeled (pre/post-update thin-wraps to Go)"
...
assert_file_not_exists "${REPO_ROOT}/scripts/windows/lib/Dispatcher.ps1" "Dispatcher.ps1 removed (Endgame B)"
assert_file_not_exists "${REPO_ROOT}/scripts/millennium.sh" "millennium.sh removed (Endgame B)"
assert_file_not_exists "${REPO_ROOT}/scripts/windows/millennium.ps1" "millennium.ps1 removed (Endgame B)"
