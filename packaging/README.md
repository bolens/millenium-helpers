...
| **bin** (`millennium-helpers-bin`) | Published release assets | `millennium-helpers-linux.tar.gz` / `…-windows.zip` |
...
Release CD embeds `bin/millennium` (linux/amd64) in the Linux tarball and
`scripts/windows/millennium.exe` in the Windows zip, and attaches standalone
Go binaries for all published platforms.
